...
def _convert_batchnorm(module, pname, nname):
    module_output = module
    if isinstance(module, torch.nn.SyncBatchNorm):
        # hard code cases where we want to use batch norm 1D
        if (nname == 'norm1' or nname == 'norm2' or pname == 'pre_layers'
                or pname == 'post_layers' or nname == '2'):
            module_output = torch.nn.BatchNorm1d(module.num_features,
            ...
            # dealing with 2D batch norm here
    ...
    for name, child in module.named_children():
        ...
        #     print(nname, name)
        module_output.add_module(name, _convert_batchnorm(child, nname, name))
    del module
